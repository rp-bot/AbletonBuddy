...
The application of artificial intelligence in music production has seen significant growth, shifting from simple information retrieval and symbolic generation (MIDI) toward integrated, intelligent assistance within Digital Audio Workstations (DAWs)~\cite{agostini2021deep,agostinelli2023musiclm}.
...
\textbf{The ``Theory vs. Production'' Gap:} Many existing models are trained on symbolic representations (music theory/MIDI) rather than audio engineering physics~\cite{roberts2018hierarchical,copet2023musicgen}.
...
\textbf{Heuristic Execution:} Using lightweight Open Sound Control (OSC) messages~\cite{wright2003open} mapped to these expert priors.
