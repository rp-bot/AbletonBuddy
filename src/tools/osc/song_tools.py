...
def query_ableton(
    query_type: Annotated[str, Field(description="Query type: tempo, is_playing, track_names, num_tracks, metronome, current_song_time, loop, signature_numerator, signature_denominator, session_record, arrangement_overdub, back_to_arranger, can_redo, can_undo, clip_trigger_quantization, groove_amount, midi_recording_quantization, nudge_down, nudge_up, punch_in, punch_out, record_mode, session_record_status, song_length")],
    params: Annotated[Optional[str], Field(
        description="Optional comma-separated params for the query")] = None
) -> str:
    """
...
def control_ableton(
    command_type: Annotated[str, Field(description="Command: start_playing, stop_playing, continue_playing, set_tempo, set_current_song_time, set_signature_numerator, set_signature_denominator, trigger_session_record, set_session_record, set_arrangement_overdub, set_metronome, set_loop, set_loop_start, set_loop_length, create_midi_track, create_audio_track, create_scene, undo, redo, tap_tempo, capture_midi, create_return_track, delete_scene, delete_return_track, delete_track, duplicate_scene, duplicate_track, jump_by, jump_to_next_cue, jump_to_prev_cue, stop_all_clips, set_back_to_arranger, set_clip_trigger_quantization, set_groove_amount, set_midi_recording_quantization, set_nudge_down, set_nudge_up, set_punch_in, set_punch_out, set_record_mode")],
    value: Annotated[Optional[Union[str, int, float]], Field(
        description="Value for the command (e.g., tempo)")] = None,
    additional_params: Annotated[Optional[str], Field(
        description="Additional comma-separated params if needed")] = None
) -> str:
    """
