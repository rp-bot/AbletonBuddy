...
## Device Loader & Browser

-   "Search for a warm pad sound, then load the best match onto track 3"
-   "Rebuild the device cache, tell me how many items you found, then load Operator on the selected track"
-   "Find a gritty bass instrument, select the bass track, and load it there"
